...
var Maps = (function () {
  ...
  var GROUND = 470;
  // 대포를 화면 왼쪽 끝(x=86)에 두었더니, 그 뒤에 놓이는 힘 손잡이가 휴대폰에서
  // 화면 밖으로 밀려 잡을 수도 당길 수도 없었다. 오른쪽으로 옮겨 뒤쪽에 당길
  // 공간을 만든다. (옮기면 사거리가 달라지므로 tools/calibrate.html로 25조합
  // 클리어 가능성을 다시 실증했다.)
  var LAUNCH = { x: 180, y: 452 };
